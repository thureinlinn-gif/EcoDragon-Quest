...
* **AI Chat:** Powered by Google Gemini API, answers health and recycling questions (e.g., “How does recycling reduce asthma risks?”).
...
2. **Set Up Gemini API Key:**
   ...
   * In `script.js`, replace `YOUR_GEMINI_API_KEY` with your key:
...
4. **Verify Functionality:**
   ...
   * Log a recycling action and check health feedback.
...
* **Log Recycle:** Enter your name to enable recycling buttons. Log items (e.g., Plastic, +10 points) or input waste weights in the calculator.
